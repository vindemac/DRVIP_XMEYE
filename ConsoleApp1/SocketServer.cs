...
public class AsynchronousSocketListener
{
    ...
    public static void StartListening()
    {
        ...
        IPEndPoint localEndPoint = new IPEndPoint(ipAddress, 34567);
    ...
    public static void ReadCallback(IAsyncResult ar)
    {
        ...
        if (bytesRead > 0)
        {
            using (var fs = new FileStream("C:\\Projects\\aff.bin", FileMode.CreateNew, FileAccess.ReadWrite))
            {
                fs.Write(state.buffer, 0, bytesRead);
 
            }
            Console.Write(Encoding.UTF8.GetString(
